...
def initialize():
    global sc, spark, items, inputfile, buckets_user, buckets_business, partition, totalSize, t
    print("Initializing...")
    t = time.time()
    candidateList = []
    frequentList = []
